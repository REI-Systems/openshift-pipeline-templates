...
class Globals {
	...
	static String imageNamespace = "REI-Systems"
	static String containerRegistry = "https://quay.kee.reisystems.io"
	static String nexusUrl = "http://nexus-cicd.apps.aws-ocp-02.kee.reisystems.io"
	static String ocpAppSuffix = "apps.aws-ocp-02.kee.reisystems.io"
}
//class Globals {
//	static String imageBase = "registry.kee.reisystems.io"
//	static String imageNamespace = "REI-Systems"
//	static String containerRegistry = "https://registry.kee.reisystems.io"
//	static String nexusUrl = "http://nexus-cicd.apps.ocp-nonprod-01.kee.reisystems.io"
//	static String ocpAppSuffix = "apps.ocp-nonprod-01.kee.reisystems.io"
//}
		...
		openshift.withCluster( "${ocp_cluster}" ) {
			openshift.withProject( "${ocp_project}" ) {
				...
				if(!dc.exists()) {
					...
					//dc = openshift.newApp("-f https://raw.githubusercontent.com/REI-Systems/openshift-pipeline-templates/master/templates/springboot-dc.yaml -p IMAGE_NAME=${Globals.imageBase}/${ocp_project}/${app_name}:latest -p APP_NAME=${app_name}").narrow("dc")
					dc = openshift.newApp("-f https://raw.githubusercontent.com/REI-Systems/openshift-pipeline-templates/master/templates/springboot-dc.yaml -p IMAGE_NAME=${Globals.imageBase}/${Globals.imageNamespace}/${app_name}:${tag} -p APP_NAME=${app_name}").narrow("dc")
				}
				else {
